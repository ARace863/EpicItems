...
public final class EpicItems extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        ShapedRecipe sr;
        if (plugin.getConfig().getBoolean("mainCraft", true)) {
            if (plugin.getConfig().getBoolean("EndermanSwordCraft", true)) {
            ...
            if (plugin.getConfig().getBoolean("AceSwordCraft", true)) {
            ...
            if (plugin.getConfig().getBoolean("RocketLauncherCraft", true)) {
            ...
            if (plugin.getConfig().getBoolean("BonemerangCraft", true)) {
            ...
            if (plugin.getConfig().getBoolean("GrapplingHookCraft", true)) {
            ...
            if (plugin.getConfig().getBoolean("EndermanBowCraft", true)) {
            ...
            if (plugin.getConfig().getBoolean("ExplosiveBowCraft", true)) {
            ...
            if (plugin.getConfig().getBoolean("RunaansBowCraft", true)) {
            ...
            if (plugin.getConfig().getBoolean("EvokerStaffCraft", true)) {
            ...
            if (plugin.getConfig().getBoolean("AirStrikeCraft", true)) {
            ...
            if (plugin.getConfig().getBoolean("KnockBackStickCraft", true)) {
                sr = new ShapedRecipe(NamespacedKey.minecraft("knockstick"), ItemManager.KnockStick);
                sr.shape(" S ", " S ", " S ");
                sr.setIngredient('S', Material.STICK);
                Bukkit.getServer().addRecipe(sr);
            }
            if (plugin.getConfig().getBoolean("HealingSwordCraft", true)) {
            ...
            if (plugin.getConfig().getBoolean("UltraDrillCraft", true)) {
